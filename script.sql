...
-- Desafio de trigger 1
CREATE TABLE UpdateBkp(
id bigint auto_increment primary key,
data_atualizacao varchar(20),
nome  varchar(100),
telefone varchar(50),
...
SELECT * FROM UpdateBkp;
DELETE FROM UpdateBkp;
TRUNCATE TABLE UpdateBkp;


UPDATE funcionarios
SET salario = 1412.00, cargo = 'Atendente de Telemarketing'
WHERE id = 26;

DROP TRIGGER triggr_UPDATE_func;
